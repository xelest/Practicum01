...
<nav class="navbar-primary">
  ...
  <ul class="navbar-primary-menu">
    <li>
      ...
      <a href="search.php"><span class="glyphicon glyphicon-search"></span><span class="nav-label">Search<span></a>
      ...
      <a href="report.php"><span class="glyphicon glyphicon-list-alt"></span><span class="nav-label">Reports</span></a>
      
      <a href="csv.php"><span class="glyphicon glyphicon-file"></span><span class="nav-label">CSV</span></a>
 
      <a href="profile.php"><span class="glyphicon glyphicon-wrench"></span><span class="nav-label"> Professors</span></a>

      <a href="profile.php"><span class="glyphicon glyphicon-cog"></span><span class="nav-label"> Others</span></a>
    </li>
  </ul>
</nav>